...
And in `nuxt.config.ts`, the magic happens:
...
<Tip>
Using `api: 'modern-compiler'` with `sass-embedded` eliminates legacy JS API deprecation warnings and provides significantly faster compilation.
</Tip>
