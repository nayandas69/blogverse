 ...
 */
function CodeBlock({ children, className, ...props }: ComponentProps<"pre"> & { children?: React.ReactNode }) {
  ...
  return (
    ...
    >
      {/* Language badge */}
      {language && (
        <span className="absolute top-2 right-2 px-2 py-0.5 text-xs font-medium bg-pink-500/20 text-pink-300 rounded">
          {language}
        </span>
      )}
